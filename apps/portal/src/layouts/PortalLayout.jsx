							...
							<div className="relative z-[1200]" ref={notifRef}>
								...
								{isNotifOpen && (
									<div className="absolute right-0 mt-2 w-80 bg-white border border-slate-200 shadow-xl rounded-md z-[1200] overflow-hidden dark:bg-slate-900 dark:border-slate-700">
										...
										<Link to="/settings" onClick={() => setIsNotifOpen(false)} className="block w-full text-center px-4 py-3 text-sm font-semibold text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-colors rounded-b-md dark:text-slate-200 dark:hover:bg-slate-800 dark:hover:text-slate-100">
							...
							<div className="relative z-[1200]" ref={profileRef}>
								...
								{isProfileOpen && (
									<div className="absolute right-0 mt-2 w-56 bg-white border border-slate-200 shadow-xl rounded-md z-[1200] py-2 overflow-hidden dark:bg-slate-900 dark:border-slate-700">
										...
										<Link to="/settings" className="flex items-center gap-2 px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 dark:text-slate-200 dark:hover:bg-slate-800">
											<FiSettings />
											Settings
										</Link>
