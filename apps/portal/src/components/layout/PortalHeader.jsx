	...
	return (
		<header className="print:hidden sticky top-0 z-40 flex h-16 items-center justify-between border-b border-gray-200 bg-white px-3 sm:px-6">
			<div className="flex items-center">
				...
				<div className="mx-2 sm:mx-4 h-6 w-px bg-gray-300" />
				<p className="hidden sm:block font-serif text-lg font-bold text-debutron-navy">Student Portal</p>
			</div>
			...
			<div className="relative flex items-center gap-2 sm:gap-6">
				<div>
					...
					{isNotifOpen && (
						<div className="absolute top-16 right-0 w-[92vw] max-w-sm bg-white border border-gray-200 shadow-xl rounded-sm z-50 overflow-hidden">
				...
				<div className="relative">
					...
					{isDropdownOpen && (
						<div className="absolute top-16 right-0 w-48 bg-white border border-gray-200 shadow-lg rounded-sm py-2 z-50">
